...
for env in envs:     
    ...
    env_vars_raw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_PRINTERNET_MHIT_DPP_RAW_{env_for_deployment.upper()}"}
    raw_task_list=PeptoDatabricksTaskList(dag=dag, env=env,source_id=source_id,process="dps_raw",super_package="raw_pepto",package="dps_raw_printernet_mhit_pepto",env_vars=env_vars_raw)
    raw_task_dict=raw_task_list.get_ops()
    
    env_vars_stdraw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_PRINTERNET_MHIT_DPP_STDRAW_{env_for_deployment.upper()}"}
    ...
    env_vars_stdraw_old = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_PRINTERNET_MHIT_DPP_STDRAW_{env_for_deployment.upper()}_OLD"}
    ...
    env_vars_rs = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_PRINTERNET_MHIT_DPP_REDSHIFT_{env_for_deployment.upper()}"}
    ...
    env_vars_lake = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_PRINTERNET_MHIT_DPP_STDRAW_DELTA_LAKE_{env_for_deployment.upper()}"}
    ...
    env_vars_ocv = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_PRINTERNET_MHIT_DPP_OCV_{env_for_deployment.upper()}"}
