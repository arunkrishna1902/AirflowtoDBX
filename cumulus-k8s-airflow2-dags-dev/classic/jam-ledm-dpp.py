...
for env in envs:     
    ...
    env_vars_raw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_JAM_LEDM_DPP_RAW_{env_for_deployment.upper()}"}
    ...
    env_vars_stdraw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_JAM_LEDM_DPP_STDRAW_{env_for_deployment.upper()}"}
    ...
    env_vars_stdraw_old = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_JAM_LEDM_DPP_STDRAW_{env_for_deployment.upper()}_OLD"}
    ...
    env_vars_rs = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_JAM_LEDM_DPP_REDSHIFT_{env_for_deployment.upper()}"}
    ...
    env_vars_lake = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_JAM_LEDM_DPP_STDRAW_DELTA_LAKE_{env_for_deployment.upper()}"}
    ...
    env_vars_ocv = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_JAM_LEDM_DPP_OCV_{env_for_deployment.upper()}"}
