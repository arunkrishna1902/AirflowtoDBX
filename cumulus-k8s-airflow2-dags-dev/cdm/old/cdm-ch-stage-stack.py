...
source_id="CONSENT_HISTORY_STAGE_STACK" 
...
for env in envs:     
    ...
    env_vars_stdraw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_CONSENT_HISTORY_STAGE_STACK_{env_for_deployment.upper()}"}
