...
source_id="DEVICE-ENV-PROFILE-HISTORY"
...
for env in envs:     
    ...
    env_vars_stdraw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_DEVICE_ENV_PROFILE_HISTORY_{env_for_deployment.upper()}"}
