...
source_id="JOB-HISTORY-PROD-STACK"
...
for env in envs:     
    ...
    env_vars_lake = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_JOB_HISTORY_INK_RSLOAD_{env_for_deployment.upper()}"}
    ...
    env_vars_rs = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_JOB_HISTORY_LASER_RSLOAD_{env_for_deployment.upper()}"}
