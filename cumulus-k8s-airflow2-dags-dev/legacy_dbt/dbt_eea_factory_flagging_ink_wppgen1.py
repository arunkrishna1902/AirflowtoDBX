...
def populate_dag(dag, image, cumulus_vars, extra_vars=None, retry_on_failure=False):
    ...
    # process dates
    # start_date_peink = cumulus_vars["process_dates"]["start_date_peink"]
    # end_date_peink = cumulus_vars["process_dates"]["end_date_peink"]

    start_date_wppgen1_ink = "2021-10-07"  # cumulus_vars["process_dates"]["start_date_wppgen1_ink"]
    end_date_wppgen1_ink = "2021-10-27"  # cumulus_vars["process_dates"]["end_date_wppgen1_ink"]

    # start_date_wppgen2_ink = cumulus_vars["process_dates"]["start_date_wppgen2_ink"]
    # end_date_wppgen2_ink = cumulus_vars["process_dates"]["end_date_wppgen2_ink"]
    ...
    # start_date_pre_target_ink = cumulus_vars["process_dates"][
    #     "start_date_pre_target_ink"
    # ]
    # end_date_pre_target_ink = cumulus_vars["process_dates"]["end_date_pre_target_ink"]

    # start_date_post_target_ink = cumulus_vars["process_dates"][
    #     "start_date_post_target_ink"
    # ]
    # end_date_post_target_ink = cumulus_vars["process_dates"]["end_date_post_target_ink"]
    ...
    # add_eea_flag_peink = _get_dbt_operation_task(
    #     dag,
    #     "add-eea-flag-peink",
    #     namespace,
    #     image,
    #     dbt_run_operation_cmd,
    #     selector=f"""rem_add_eea_flag_peink --profile ink --args "{{source_id: PEINK, start_date: {start_date_peink}, end_date: {end_date_peink}}}" """,
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )

    add_eea_flag_wppgen1 = _get_dbt_operation_task(
        dag,
        "add-eea-flag-wppgen1",
        namespace,
        image,
        dbt_run_operation_cmd,
        selector=f"""rem_add_eea_flag_wppgen1_ink --profile ink --args "{{source_id: WPPGEN1, start_date: {start_date_wppgen1_ink}, end_date: {end_date_wppgen1_ink}}}" """,
        vars=dbt_vars,
        env_vars=env_vars,
        retries=retry_count,
    )

    # add_eea_flag_wppgen2 = _get_dbt_operation_task(
    #     dag,
    #     "add-eea-flag-wppgen2",
    #     namespace,
    #     image,
    #     dbt_run_operation_cmd,
    #     selector=f"""rem_add_eea_flag_wppgen2_ink --profile ink --args "{{source_id: WPPGEN2_SCHEDULED, start_date: {start_date_wppgen2_ink}, end_date: {end_date_wppgen2_ink}}}" """,
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )

    # gotham_flag_no_allow_list_ink = _get_dbt_operation_task(
    #     dag,
    #     "gotham-flag-no-allow-list-ink",
    #     namespace,
    #     image,
    #     dbt_run_operation_cmd,
    #     selector=f"""rem_add_eea_flag_no_allow_list_ink --profile ink --args "{{source_id: GOTHAM_LEDM, start_date: {start_date_gotham_ink}, end_date: {end_date_gotham_ink}}}" """,
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )

    # set_null_to_false_pre_target_ink = _get_dbt_operation_task(
    #     dag,
    #     "set-null-to-false-pre-target-ink",
    #     namespace,
    #     image,
    #     dbt_run_operation_cmd,
    #     selector=f"""set_null_to_false_pre_target_ink --profile ink --args "{{start_date: {start_date_pre_target_ink}, end_date: {end_date_pre_target_ink}}}" """,
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )

    # set_null_to_false_post_target_ink = _get_dbt_operation_task(
    #     dag,
    #     "set-null-to-false-post-target-ink",
    #     namespace,
    #     image,
    #     dbt_run_operation_cmd,
    #     selector=f"""set_null_to_false_post_target_ink --profile ink --args "{{start_date: {start_date_post_target_ink}, end_date: {end_date_post_target_ink}}}" """,
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )

    unload_flag_ids_ink = _get_dbt_operation_task(
        dag,
        "unload-flag-ids-ink",
        namespace,
        image,
        dbt_run_operation_cmd,
        selector="unload_flag_ids_ink --profile ink",
        vars=dbt_vars,
        env_vars=env_vars,
        retries=retry_count,
    )

    # test_wppg2_ink_flagging = _get_dbt_task(
    #     dag,
    #     "test-wppg2-ink-flagging",
    #     namespace,
    #     image,
    #     dbt_test_cmd,
    #     selector="--profile ink --models tag:wpp_g2_ink_flagging",
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )

    test_wppg1_ink_flagging = _get_dbt_task(
        dag,
        "test-wppg1-ink-flagging",
        namespace,
        image,
        dbt_test_cmd,
        selector="--profile ink --models tag:wpp_g1_ink_flagging",
        vars=dbt_vars,
        env_vars=env_vars,
        retries=retry_count,
    )

    # test_peink_flagging = _get_dbt_task(
    #     dag,
    #     "test-peink-flagging",
    #     namespace,
    #     image,
    #     dbt_test_cmd,
    #     selector="--profile ink --models tag:peink_flagging",
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )

    # test_gotham_ink_flagging = _get_dbt_task(
    #     dag,
    #     "test-gotham-ink-flagging",
    #     namespace,
    #     image,
    #     dbt_test_cmd,
    #     selector="--profile ink --models tag:gotham_ink_flagging",
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )

    # test_ink_set_false = _get_dbt_task(
    #     dag,
    #     "test-ink-set-false",
    #     namespace,
    #     image,
    #     dbt_test_cmd,
    #     selector="--profile ink --models tag:ink_set_false",
    #     vars=dbt_vars,
    #     env_vars=env_vars,
    #     retries=retry_count,
    # )
    
    # test_ink_count_compare_databricks = _get_databricks_task(
    #     dag,
    #     "test-ink-count-compare-databricks-trigger",
    #     namespace,
    #     dbx_image,
    #     dbx_command,
    #     env_vars=cumulus_vars["dbx_vars"],
    #     retries=retry_count,
    # )

    current_task >> add_eea_flag_wppgen1 >> test_wppg1_ink_flagging >> unload_flag_ids_ink
    
    # (
    #     current_task
    #     >> [
    #         add_eea_flag_peink,
    #         add_eea_flag_wppgen1,
    #         add_eea_flag_wppgen2,
    #         gotham_flag_no_allow_list_ink,
    #     ]
    #     >> set_null_to_false_post_target_ink
    #     >> set_null_to_false_pre_target_ink
    #     >> [
    #         test_ink_set_false,
    #         test_peink_flagging,
    #         test_wppg1_ink_flagging,
    #         test_wppg2_ink_flagging,
    #         test_gotham_ink_flagging,
    #     ]
    #     >> unload_flag_ids_ink
    #     >> test_ink_count_compare_databricks
    # )
