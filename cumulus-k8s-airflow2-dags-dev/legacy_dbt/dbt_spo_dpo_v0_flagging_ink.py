...
import dbt.dbt_spo_dpo_v0_factory_flagging as spo_factory
...
dag = DAG(
    dag_id="cumulus-dbt-spo-dpo-v0-flagging-ink",
    default_args=args,
...
date_list = spo_factory.batch_dates(
    list(
        spo_factory.date_range(start_date,end_date,1)
        ))


gen1 = spo_factory.build_taskgroup_ink(dag=dag,
    group_id='wppgen1_ink',
    image=image,
    cumulus_vars=cumulus_vars,
    extra_vars=extra_vars,
    date_list=date_list,
...
gen2 = spo_factory.build_taskgroup_ink(dag=dag,
    group_id='wppgen2_ink',
    image=image,
    cumulus_vars=cumulus_vars,
    extra_vars=extra_vars,
    date_list=date_list,
...
gotham = spo_factory.build_taskgroup_ink(dag=dag,
    group_id='gotham_ink',
    image=image,
    cumulus_vars=cumulus_vars,
    extra_vars=extra_vars,
...
test_ink_spo = spo_factory.build_taskgroup_ink(dag=dag,
...
test_ink_strnec = spo_factory.build_taskgroup_ink(dag=dag,
