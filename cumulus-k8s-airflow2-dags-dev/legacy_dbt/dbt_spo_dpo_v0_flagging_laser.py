...
dag = DAG(
    dag_id="cumulus-dbt-spo-dpo-v0-flagging-laser",
    default_args=args,
...
gen2 = spo_factory.build_taskgroup_laser(dag=dag,
    group_id='wppgen2_laser',
    image=image,
    cumulus_vars=cumulus_vars,
    extra_vars=extra_vars,
    date_list=date_list,
...
gotham = spo_factory.build_taskgroup_laser(dag=dag,
    group_id='gotham_laser',
    image=image,
    cumulus_vars=cumulus_vars,
    extra_vars=extra_vars,
    date_list=date_list,
...
test_ink_spo = spo_factory.build_taskgroup_laser(dag=dag,
...
test_ink_strnec = spo_factory.build_taskgroup_laser(dag=dag,
