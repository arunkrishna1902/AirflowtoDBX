        ...
        if date_list != None:
            for i in date_list:
                ...
                dynamic_task = _get_dbt_operation_task(
                    ...
                    selector=f"""dpo_v0_reprocess_synthetic_privacy_object --profile ink --args "{{source_id: {source_id}, source_name: ink, start_date: {i[0]}, end_date: {i[1]}}}" """,
                    vars=dbt_vars,
                    env_vars=env_vars,
                    retries=retry_count,
                )
