...
import dbt.dbt_eea_factory_flagging_ink_wppgen1 as eea_factory
...
cumulus_vars["dbx_vars"]["run_params"] = json.dumps({"environment":cumulus_vars["dbx_vars"]["env"], "allowList_eea_process":"eea_flag", "ink_laser_process":"ink"})
...
dag = DAG(
    dag_id="cumulus-dbt-eea-flagging-ink-wppgen1",
    default_args=args,
