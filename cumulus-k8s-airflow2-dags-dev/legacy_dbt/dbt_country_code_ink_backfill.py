...
import dbt.dbt_country_code_ink_backfill_factory as eea_factory
...
cumulus_vars["dbx_vars"]["run_params"] = json.dumps({"environment":cumulus_vars["dbx_vars"]["env"]})
...
dag = DAG(
    dag_id="cumulus-country-code-ink-backfill",
    default_args=args,
    ...
    tags=["fw_country_code_remediation"],
)
